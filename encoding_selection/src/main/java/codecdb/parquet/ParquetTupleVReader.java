...
import codecdb.query.ColumnPrimitiveConverter;
 ...
 */
public class ParquetTupleVReader {
    ...
    private ColumnTempTable tempTable;
    ...
    public ParquetTupleVReader(URI inputFile) throws IOException, VersionParser.VersionParseException {
        ...
        tempTable = new ColumnTempTable(schema);
    ...
    public Object[] read() throws IOException {
        ...
        if (currentRowGroup == null)
            return null;
        Object[] result = tempTable.getRecord((int)rowGroupReadCounter);
        rowGroupReadCounter++;
        readCounter++;
        return result;
    }
            ...
            if (currentRowGroup != null) {
                ...
                for (int i = 0; i < readers.length; i++) {
                    ...
                    readers[i] = new ColumnReaderImpl(cd, currentRowGroup.getPageReader(cd),
                            tempTable.getConverter(i).asPrimitiveConverter(), version);
